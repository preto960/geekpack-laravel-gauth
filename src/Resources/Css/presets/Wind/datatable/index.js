export default {
    ...
    column: {
        headercell: ({ context, props }) => ({
            class: [
                ...
                // Spacing
                context?.size === 'small' ? 'py-2.5 px-2' : context?.size === 'large' ? 'py-5 px-4' : 'py-2 px-1',
                // Color
    ...
    bodyrow: ({ context, props }) => ({
        class: [
            ...
            { 'bg-primary-50 text-primary-700 dark:bg-primary-400/30': context.selected && !context.stripedRows },
