    ...
    input: {
        root: ({ parent, context }) => ({
            class: [
                ...
                'border-primary-300 dark:border-primary-600 focus:outline-none focus:outline-offset-0 focus:ring-[1px] focus:ring-inset focus:ring-primary-500 dark:focus:ring-primary-400',
